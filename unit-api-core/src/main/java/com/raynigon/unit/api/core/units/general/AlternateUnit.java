...
public class AlternateUnit<Q extends Quantity<Q>> extends AbstractUnit<Q> implements IUnit<Q> {
  ...
  public AlternateUnit(
      String systemId, String symbol, String name, Unit<Q> parentUnit, Class<Q> quantityType) {
    ...
    if (!(parentUnit instanceof AbstractUnit))
      throw new IllegalArgumentException(
          "The parent unit: " + parentUnit + " is not an AbstractUnit");
    if (!((AbstractUnit) parentUnit).isSystemUnit())
      throw new IllegalArgumentException(
          "The parent unit: " + parentUnit + " is not an unscaled SI unit");
    this.parentUnit =
        parentUnit instanceof AlternateUnit
  ...
  /**
   * Returns the parent unit of this alternate unit, always a system unit and never an alternate
   * unit.
   *
